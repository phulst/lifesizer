...
var swfZoomDetection = {
	...
	_detectSWFWidth:2, // width of test flash
	...
	createNode:function( obj ){
		...
		if( this.hasPlayerVersion() ){
			swfobject.embedSWF("/bin/swfZoomDetection.swf", this._nodeId, this._detectSWFWidth, this._detectSWFHeight, this._flashVersion,"expressInstall.swf", this._flashvars, this._params, this._attributes);
		}else{
			return false;			
		}

Lifesizer::Application.configure do
  ...
  # required by devise
  config.action_mailer.default_url_options = { :host => 'beta.lifesizer.com' }

  # Enable threaded mode
  # config.threadsafe!

  # as recommended in startup output
  ...
  config.assets.precompile += %w{
      ...
      bookmarklet.css bookmarklet-https.css common.css common_minimal.css images_configure.css images_edit.css view.css widget_popup.css
